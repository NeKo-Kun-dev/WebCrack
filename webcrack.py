...
def logo():
 ...
 ░░░░  ███████ ]▄▄▄▄▄▄▄▄          
█▄█████████████▄█             Автор:༒︎Neko Kun Dev༒︎
[████████████████████].Telegram:t.me/Neko_Blog☠︎︎
 ..◥ ▲ ▲ ▲ ▲ ▲ ▲ ◤..      	      Description: Этот инструмент предназначен для поиска учетных данных по умолчанию для маршрутизаторов, сетевых устройств, веб-приложений и т. д. 
